...
namespace ReGoap.Unity.FSMExample.Actions
{
    ...
    public class CraftRecipeAction : ReGoapAction<string, object>
    {
        ...
        protected override void Awake()
        {
            ...
            // could implement a more flexible system that handles dynamic resources' count
        ...
        private void CalculateSettingsList(GoapActionStackData<string, object> stackData)
        {
            ...
            //每个workstation一套setting
            foreach (var workstationsPair in
        ...
        public override void Run(IReGoapAction<string, object> previous,
            IReGoapAction<string, object> next, ReGoapState<string, object> settings,
            ...
            Action<IReGoapAction<string, object>> done, Action<IReGoapAction<string, object>> fail)
        {
            ...
            {
                ReGoapLogger.Log(
                    "[CraftRecipeAction] crafted recipe " + recipe.GetCraftedResource());
                done(this);
            }
            else
            {
