...
namespace ReGoap.Unity
{
    public class ReGoapAction<T,W> : MonoBehaviour, IReGoapAction<T,W>
    {
        ...
        public virtual void Run(IReGoapAction<T, W> previous, IReGoapAction<T, W> next,
        ...
        public virtual void PlanEnter(IReGoapAction<T, W> previousAction, 
            IReGoapAction<T, W> nextAction, ReGoapState<T, W> settings, ReGoapState<T, W> goalState)
        {
        }

        public virtual void PlanExit(IReGoapAction<T, W> previousAction, 
            IReGoapAction<T, W> nextAction, ReGoapState<T, W> settings, ReGoapState<T, W> goalState)
        {
        }
