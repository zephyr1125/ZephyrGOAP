...
namespace ReGoap.Core
{
    ...
    public interface IReGoapAction<T, W>
    {
        ...
        void Run(IReGoapAction<T, W> previousAction, IReGoapAction<T, W> nextAction,
        ...
        void PlanEnter(IReGoapAction<T, W> previousAction, IReGoapAction<T, W> nextAction,
            ReGoapState<T, W> settings, ReGoapState<T, W> goalState);
        
        // Called when the plan, which had this action, has either failed or completed
        void PlanExit(IReGoapAction<T, W> previousAction, IReGoapAction<T, W> nextAction,
            ReGoapState<T, W> settings, ReGoapState<T, W> goalState);
