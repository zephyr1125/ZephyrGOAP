...
{
    public struct TransferAction : IComponentData, IAction
    {
        public NativeString64 GetName()
        {
            return nameof(TransferAction);
        }
        ...
        public Entity GetNavigatingSubject(ref State targetState, ref State setting, ref StackData stackData,
            ref StateGroup preconditions)
        {
