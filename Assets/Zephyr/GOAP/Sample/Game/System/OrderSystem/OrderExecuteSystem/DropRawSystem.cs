...
namespace Zephyr.GOAP.Sample.Game.System.OrderSystem.OrderExecuteSystem
{
    ...
    public class DropRawSystem : JobComponentSystem
    {
        ...
        protected override JobHandle OnUpdate(JobHandle inputDeps)
        {
            ...
            var actions = GetComponentDataFromEntity<DropRawAction>(true);
            var time = Time.ElapsedTime;
            
            //先走时间+播动画
            var initHandle = Entities.WithName("DropRawInitJob")
                .WithAll<DropRawOrder>()
